        ...
        <div className="card col-md-6" style={{margin: '0 0 2rem 0'}}>
          <div className="card-body">
            <div className="col-12" style={{display: 'flex'}}>
              ...
              <h5 className="card-title circular"><a href={`/business-profile/${this.state.id}`} style={{textDecoration:'none', color: '#333'}}> {this.state.name}</a></h5>
                <h6 className="card-subtitle mb-2 text-muted">{this.state.category}</h6>
              </div>
            </div>
            <div className="col-12">
              <p className="card-text">{this.state.profile}</p>
              <h6 className="card-subtitle mb-2 text-muted" style={{fontSize: '.8rem'}}>{this.state.location}</h6>
            </div>
          </div>
        </div>
      </div>
